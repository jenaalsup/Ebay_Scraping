...
def save_scraped_data(sdata, brand):
    ...
    var = "  TOTAL VALUE OF AVAILABLE AND SOLD ITEMS: $" + str(available_value + sold_value)
    show_total_value = {
                'url':'',
                'title':var,
                'price':'',
    ...
    sdata.insert(0, show_available_stats)
    sdata.insert(1, show_sold_stats)
    sdata.insert(2, show_total_value)
