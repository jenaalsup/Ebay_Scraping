  ...
  while True:
    ...
    if scraped_products:
      ...
      if count < 200:
        ...
        sold_stats = "  SOLD STATS for Brand: %s   Total Sold Items: %d\r\n  Value: $%0.2f "%( brand, 
            total_count, value)   
        print(sold_stats)
        sold_value = value
...
def ebay_process_data(name_brand):
  global ebay_count
  global ebay_total_value
  global ebay_result_count
  global ebay_max_page
